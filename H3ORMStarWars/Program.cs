...
namespace H3ORMStarWars
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var rotationsperioden = planets
                .Where(x => x.RotationPeriod > 40).OrderBy(x => x.RotationPeriod);

            foreach (var start in rotationsperioden)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var rotationsperioden2 = planets
                .Where(x => x.RotationPeriod > 10 && x.RotationPeriod < 20).OrderBy(x => x.Name);

            foreach (var start in rotationsperioden2)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var rotationsperioden3 = planets
                .Where(x => x.RotationPeriod > 30).OrderBy(x => x.Name).OrderBy(x => x.RotationPeriod);

            foreach (var start in rotationsperioden3)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var rotationsperioden4 = planets
                .Where(x => x.RotationPeriod < 30 || x.SurfaceWater > 50)
                .Where(x => x.Name.Contains("ba"))
                .OrderBy(x => x.Name).ThenBy(x => x.RotationPeriod).ThenBy(x => x.RotationPeriod);

            foreach (var start in rotationsperioden4)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var surfaceWater = planets
                .Where(x => x.SurfaceWater > 0)
                .OrderByDescending(x => x.SurfaceWater);
            ...
            var list2 = planets
               .Where(x => x.Terrain != null && x.Terrain.Contains("rainforests"));

            var jejheuej = list1.Union(list2);

            foreach (var start in jejheuej)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var dessert = planets
           .Where(x => x.Terrain != null && x.Terrain.Contains("deserts"));

            foreach (var start in dessert)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var sump = planets
           .Where(x => x.Terrain != null && x.Terrain.Contains("swamps")).OrderBy(x => x.RotationPeriod).ThenBy(x => x.Name);

            foreach (var start in sump)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var regex = planets
                .Where(x => Regex.IsMatch(x.Name, @"(aa|ee|ii|uu|oo|yy)"));

            var almostRegex = planets
                .Where(x => x.Name.Contains("aa") || x.Name.Contains("ee") || x.Name.Contains("ii") || x.Name.Contains("oo")
                 || x.Name.Contains("rr") || x.Name.Contains("nn")).OrderBy(x => x.Name);

            foreach (var start in regex)
            {
                Console.WriteLine(start.Name);
            }
            ...
            var regex2 = planets
           .Where(x => x.Name.Contains("kk") || x.Name.Contains("ll") || x.Name.Contains("rr") || x.Name.Contains("nn")).OrderBy(x => x.Name);

            foreach (var start in regex2)
            {
                Console.WriteLine(start.Name);
            }
        ...
        static List<Planet> LoadData()
        {
            List<Planet> planets = new List<Planet>()
            {
                ...
                new Planet { Name="Dagobah",Terrain= new List<string>{ "swamps","jungles"},RotationPeriod=23,SurfaceWater=8},
                ...
                new Planet { Name="Geonosis",Terrain= new List<string>{ "rock","deserts","mountain","barren"},RotationPeriod=30,SurfaceWater=5,Diameter=11370, Population=100000000000},
